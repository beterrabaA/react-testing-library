...
Escrever testes para uma aplicação React já criada e configurada,utitilizando -- e a biblioteca --
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-024-a-project-react-testing-library.git`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-024-a-project-react-testing-library`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-024-a-project-react-testing-library`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-024-a-project-react-testing-library/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-024-a-project-react-testing-library/pulls) e confira que o seu _Pull Request_ está criado
